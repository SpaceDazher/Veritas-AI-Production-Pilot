...
const migrationPath = path.join(root, 'migrations', '002_command_path.sql');
...
if (result.status !== 0) throw new Error(`command-path migration failed: ${`${result.stderr ?? ''}`.trim().slice(-2000)}`);
